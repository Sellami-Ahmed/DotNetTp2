...
namespace TP2.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var products=prodcutRepository.GetAll();
        ...
        {
            var product = prodcutRepository.Get(id);
            return View(product);
        }
        ...
        public ActionResult Create(CreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                prodcutRepository.Add(newProduct);
        ...
        public ActionResult Edit(EditViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Product product = prodcutRepository.Get(model.Id);
                ...
                Product updatedProduct = prodcutRepository.Update(product);
        ...
        {
            Product product = prodcutRepository.Get(id);
        ...
        public ActionResult Delete(Product product)
        {
            try
            {
                prodcutRepository.Delete(product.Id);
